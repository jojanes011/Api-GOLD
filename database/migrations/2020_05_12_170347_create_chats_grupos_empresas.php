...
class CreateChatsGruposEmpresas extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('chats_grupos_empresas', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('chats_grupos_empresas');
    }
}
